...
W = 0x11
S = 0x1F
KEY_I = 0x49  # Virtual Key Code for 'i'
...
# Function to detect head turn and move cursor
...
def move_cursor_based_on_turn(nose_diff_x):
    sensitivity = 10  # Adjust sensitivity for raw movement
    threshold = 0.015  # Threshold for detecting a significant turn
